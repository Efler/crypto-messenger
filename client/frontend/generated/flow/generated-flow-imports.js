...
import $cssFromFile_0 from 'Frontend/styles/chat/chat-styles.css?inline';

injectGlobalCss($cssFromFile_0.toString(), 'CSSImport end', document);
import $cssFromFile_1 from 'Frontend/styles/hello/hello-styles.css?inline';

injectGlobalCss($cssFromFile_1.toString(), 'CSSImport end', document);
import $cssFromFile_2 from 'Frontend/styles/menu/menu-styles.css?inline';
